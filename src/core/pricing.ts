...
// client components.
//
// SOURCE OF TRUTH. `web/src/lib/pricing.ts` is a generated copy (the web app
// cannot import across the `web/` boundary, so `prebuild`/`build` cp this file
// into it). Edit HERE; never edit the web copy by hand.
//
